...
const BudgetReportEventWise = () => {
  ...
  const getEventDisplay = (record) => {
    ...
    return record.eventName ?? record.eventId ?? "ΓÇö";
  };
  ...
  const columns = [
    ...
    },
    {
      ...
      width: 160,
      render: (val) =>
        val ? new Date(val).toLocaleDateString("en-IN", { dateStyle: "medium" }) : "ΓÇö",
    },
    {
      title: "Actions",
      key: "actions",
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div>
                ...
                <Text type="secondary" className="text-sm">
                  Event-wise list ΓÇö view details, edit, or open accounts allocation.
                </Text>
              </div>
            </div>
            <Button
