...
//     axios.post(`${API_BASE_URL}vendor`, values, config)
//       .then(response => {
...
//           </Col>
//           <Col xs={24} sm={12}>
//             <Form.Item name="person_category" label="Category of Person (Individual/HUF/FIRM/COMPANY)" rules={[{ required: true, message: 'Please enter category of person' }]}>
...
//         <Row gutter={16}>
//           <Col xs={24} sm={8}>
//             <Form.Item name="cont_person" label="Contact Person" rules={[{ required: true, message: 'Please enter contact Company Name' }]}>
...
//         <Row gutter={16}>
//           <Col xs={24} sm={12}>
//             <Form.Item name="vendor_type" label="Type Of Vendor (Material/Labour/Composite/Expense)" rules={[{ required: true, message: 'Please enter type of vendor' }]}>
