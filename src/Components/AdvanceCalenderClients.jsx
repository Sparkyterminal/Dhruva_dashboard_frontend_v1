          ...
          et.advances.forEach((advance, advIdx) => {
            ...
            try {
              ...
              calendarEvents.push({
                ...
                backgroundColor: isFullyPaid ? "#10b981" : isPending ? "#f59e0b" : "#6b7280",
                borderColor: isFullyPaid ? "#059669" : isPending ? "#d97706" : "#4b5563",
                textColor: "#ffffff",
              });
            } catch (error) {
        ...
        <div className="p-1.5 text-xs overflow-hidden leading-tight">
          ...
          {isPending && (
            <div className="text-white font-semibold text-[10px] mt-1">
              Pending: ₹{Number(expectedAmount - receivedAmount).toLocaleString()}
            </div>
          )}
        </div>
      );
          ...
          <FullCalendar
            ...
            eventDidMount={(info) => {
              try {
                ...
                tooltip += `\nReceived: ₹${Number(receivedAmount).toLocaleString()}`;
                if (pendingAmount > 0) {
                  tooltip += `\nPending: ₹${Number(pendingAmount).toLocaleString()}`;
                }
                  ...
                  >
                    <div className="flex justify-between items-start mb-3">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          >
                            {isFullyPaid ? "Paid" : isPending ? "Pending" : "Not Received"}
                          </span>
                        ...
                        {advance.eventType?.eventType && (
                          <p className="text-sm text-gray-500">
                            Event Type: {formatText(advance.eventType.eventType)}
                          </p>
                        )}
                      </div>
                    ...
                    <div className="grid grid-cols-3 gap-4 mt-4 pt-4 border-t border-gray-200">
                      ...
                      <div>
                        ...
                        <p className={`text-lg font-bold ${isPending ? "text-amber-600" : "text-gray-400"}`}>
                      ...
                      <div className="mt-3 pt-3 border-t border-gray-200">
                        <div className="flex items-center gap-2 text-amber-600">
                          ...
                          <span className="text-sm font-medium">
                            Payment of ₹{pendingAmount.toLocaleString()} is pending
                          </span>
                        </div>
                      </div>
                    )}
